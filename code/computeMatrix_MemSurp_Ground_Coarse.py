...
for lang, mod in pairs:
    print((lang, mod))
    command = ["/u/nlp/anaconda/main/anaconda3/envs/py37-mhahn/bin/python", "computeBigramCE.py", "--language="+lang, "--model="+mod, "--BASE_DIR=manual_output_ground_coarse_final"]
    print(" ".join(command))
